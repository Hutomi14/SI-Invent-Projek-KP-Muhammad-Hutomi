        <div class="col-md-12 top-20 padding-0">
          <div class="col-md-12">
            <div class="panel">
              <div class="panel-heading"><h3>Data Aset Bagian Umum</h3></div>
                ...
                <div class="responsive-table">
                  <table id="datatables-example" class="table table-striped table-bordered datatab" width="100%" cellspacing="0">
                    ...
                    <tbody>
                      ...
                      $kode = $koneksi->query("SELECT data_aset.kode_aset,  data_aset.nama_aset, data_aset.nama_kategori, kelola_aset.jumlah FROM data_aset INNER JOIN kelola_aset ON data_aset.kode_aset = kelola_aset.kode_aset where kelola_aset.kode_lokasi='4'");
